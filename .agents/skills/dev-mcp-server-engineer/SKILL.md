...
Инженер по разработке детерминированного MCP‑сервера «Инспектор зависимостей и лицензий». Отвечает за реализацию ядра, scanners, policy_engine, SBOM и MCP‑tools строго по спецификации из `plan/01–06` и `.cursorrules`.
